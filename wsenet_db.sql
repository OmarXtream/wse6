...
--
-- Host: localhost:3306
-- Generation Time: May 19, 2019 at 04:54 AM
...
CREATE TABLE `sitesettings` (
  ...
  `closeps` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `sitesettings` (`closeSite`, `closeapply`, `closepaypal`, `closestc`, `closemobily`, `closeps`) VALUES
(0, 0, 0, 0, 0, 0);
