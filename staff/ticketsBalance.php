...
<div class="block-content p-5" id="ticketInfo" data-toggle="slimscroll" data-height="350px">
		...
		exit(header('Location: ./ticketsBalance'));
	}
} else {
$conn = $database->openConnection();
$alltickets = $conn->query('SELECT * FROM ticket WHERE type = 5 AND status != 0 ORDER BY time DESC');
ob_end_flush();
 ?>
...
<main id="main-container">
                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">التذاكر » <small>طلب الإرباح</small></h3>
                        </div>
...
function _backTicketStaff(){
	window.location = "ticketsBalance";
}
