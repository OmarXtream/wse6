...
if (session_status() !== PHP_SESSION_ACTIVE) {
	...
	ini_set('session.cookie_domain', '.wse6.com');
    session_start();
}
$amstaff = true;
...
<html lang="en" class="no-focus">
    <head>
        ...
        <title>Wse6 &bull; Staff Login</title>
            ...
            <div class="content content-full overflow-hidden">
                <div class="py-30 text-center">
                    <a class="link-effect font-w700" href="#">
                        <span class="font-size-xl text-primary-dark">وسيط</span>&nbsp;&nbsp;<span class="font-size-xl">تسجيل دخول الإدارة</span>
                    </a>
                </div>
