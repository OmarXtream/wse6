...
if(isset($pageName) && $pageName == "home"){
	...
	$homeInfo= $conn->query('Select (select count(*) from Customers WHERE verify = 0) as CNotActivated, (select count(*) from Customers WHERE verify = 1) as CActivated, (SELECT count(*) FROM mediations WHERE status = 1) as MNotCompleted, (select count(*) FROM mediations WHERE status = 0) as MCompleted, (SELECT count(*) FROM Customers WHERE isStaff = 1) as StaffCount')->fetch();	$database->closeConnection();
	
}
$conn = $database->openConnection();
$clientData=$conn->query("SELECT rank,username,img FROM Customers WHERE id={$_SESSION['staffId:wse6']}");
...
<!--[if gt IE 9]><!--> <html lang="en" class="no-focus"> <!--<![endif]-->
    <head>
        ...
        <link rel="shortcut icon" href="assets/media/favicons/wse6.png">
        <link rel="icon" type="image/png" sizes="192x192" href="assets/media/favicons/wse6-192x192.png">
        <link rel="apple-touch-icon" sizes="180x180" href="assets/media/favicons/wse6-180x180.png">
                    ...
                    <div class="sidebar-content">
                            ...
                            <div class="content-header-section text-center align-parent sidebar-mini-hidden">
                                ...
                                <div class="content-header-item">
                                    <a class="link-effect font-w700" href="#">
                                        <span class="font-size-xl text-dual-primary-dark">وسيط</span>&nbsp;<span class="font-size-xl text-primary">الإدارة</span>
                                    </a>
                                </div>
                                <!-- END Logo -->
                            </div>
                            ...
                            <div class="sidebar-mini-hidden-b text-center">
                                ...
                                <ul class="list-inline mt-10">
									<li class="list-inline-item">
                                        ...
                                        <a class="link-effect text-dual-primary-dark font-size-xs font-w600 text-uppercase" href=""><?=getRank($_SESSION['staffId:wse6']);?></a>
                                    </li>
                                    <li class="list-inline-item">
                                        <!-- Layout API, functionality initialized in Codebase() -> uiApiLayout() -->
                        ...
                        <div class="content-side content-side-full">
                            <ul class="nav-main">
									...
									<li>
										<a class="nav-submenu <?php if($pageName == "ticket" || $pageName == "ticketsBalance" || $pageName == "ticketsForwarded" || $pageName == "ticketsReply"){ echo 'active'; } ?>" data-toggle="nav-submenu" href="#"><i class="si si-envelope"></i><span class="sidebar-mini-hide">التذاكر</span></a>
										<ul>
											<li>
											<a href="ticket">التذاكر</a>
											</li>
											<li>
											<a href="ticketsBalance">طلب الإرباح</a>
											</li>
											<?php if(rankPermission($_SESSION['staffId:wse6'],5,true)){?>
											<li>
											<a href="ticketsForwarded">إلى المؤسس</a>
											</li>
											<?php } ?>
											<li>
											<a href="ticketsReply">الشكاوي</a>
											</li>
										</ul>
									</li>
									<?php if(rankPermission($_SESSION['staffId:wse6'],5,true)){?>
									...
									<?php } ?>
									<?php if(!rankPermission($_SESSION['staffId:wse6'],3,true)){?>
									<li>
										<a href="mediationsOrders" <?php if($pageName == "mediationsOrders"){ echo 'class="active"'; } ?>> <i class="fa fa-briefcase"></i><span class="sidebar-mini-hide">طلبات الوساطة</span></a>
									</li>
									
									<li>
										<a href="mediationsacc" <?php if($pageName == "mediationsacc"){ echo 'class="active"'; } ?>> <i class="si si-layers"></i><span class="sidebar-mini-hide">قبول الوساطات</span></a>
									</li><?php } ?>
									<li>
										<a href="applyList" <?php if($pageName == "applyList"){ echo 'class="active"'; } ?>> <i class="si si-envelope-letter"></i><span class="sidebar-mini-hide">سجل التقديم</span></a>
									</li>
									<?php if(rankPermission($_SESSION['staffId:wse6'],4,true) OR rankPermission($_SESSION['staffId:wse6'],5,true)){?>
									<li>
										<a href="addsection" <?php if($pageName == "addsection"){ echo 'class="active"'; } ?>> <i class="si si-docs"></i><span class="sidebar-mini-hide">إضافة قسم</span></a>
									</li>
									<?php } ?>
									<?php if(rankPermission($_SESSION['staffId:wse6'],5,true)){ ?>
									<li>
									...
									<?php } ?>
									<?php if(rankPermission($_SESSION['staffId:wse6'],2,true) || rankPermission($_SESSION['staffId:wse6'],4,true) || rankPermission($_SESSION['staffId:wse6'],5,true)){ ?>
									<li>
										<a href="staffinfo" <?php if($pageName == "staffinfo"){ echo 'class="active"'; } ?>> <i class="si si-users"></i><span class="sidebar-mini-hide">معلومات الإدارة</span></a>
									</li>
									<?php } ?>
									<?php if(rankPermission($_SESSION['staffId:wse6'],2,true) || rankPermission($_SESSION['staffId:wse6'],4,true) || rankPermission($_SESSION['staffId:wse6'],3,true) || rankPermission($_SESSION['staffId:wse6'],1,true) || rankPermission($_SESSION['staffId:wse6'],5,true)){ ?>
									<li>
										<a href="https://wse6.com/dashboard/requestBalance" <?php if($pageName == "requestBalance"){ echo 'class="active"'; } ?>> <i class="si si-diamond"></i><span class="sidebar-mini-hide">طلب الأرباح</span></a>
									</li>
									<?php } ?>
