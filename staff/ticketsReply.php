...
<div class="block-content p-5" id="ticketInfo" data-toggle="slimscroll" data-height="350px">
		...
		exit(header('Location: ./ticketsReply'));
	}
} else {
$conn = $database->openConnection();
$alltickets = $conn->query('SELECT * FROM ticket WHERE type = 3 AND status != 0 AND needed_see = '.$_SESSION['staffId:wse6'].'');
ob_end_flush();
 ?>
...
<main id="main-container">
                ...
                <div class="content">
                    ...
                    <div class="block">
                        <div class="block-header block-header-default">
                            <h3 class="block-title">جميع الشكاوي » <small>المطلوب لها تفسير.</small></h3>
                        </div>
