...
if($_SERVER['REQUEST_METHOD'] == "GET"){
	...
	if(!isset($_SESSION['_token']) OR !isset($_GET['token']) OR $_GET['token'] != $_SESSION['_token'] OR !isset($_SESSION['staffId:wse6'])){
	...
	if(isset($_GET['cardStatus'],$_GET['cardId'])){
		...
		}elseif(!rankPermission($_SESSION['staffId:wse6'],5,true)){
			die();
